...
public class FormSaveTests : IClassFixture<FormSaveWebAppFactory>
{
    ...
    static HttpRequestMessage BuildSaveRequest(int id, string date, string area, string token, bool includeEditingId)
    {
        var body = BuildHourOneSaveBody(id, date, area, token, includeEditingId);
    ...
    static IEnumerable<KeyValuePair<string, string>> BuildHourOneSaveBody(
        int id, string date, string area, string token, bool includeEditingId)
    {
