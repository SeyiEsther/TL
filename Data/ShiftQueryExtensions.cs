...
public static class ShiftQueryExtensions
{
    ...
    // so they must be excluded from shift dashboards, history, and exports —
    // otherwise they distort KPIs. Keep this in one place so every shift-centric query stays consistent.
